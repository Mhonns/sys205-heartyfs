all:
	...
	gcc -o bin/heartyfs_rm src/heartyfs_ops.c src/op/heartyfs_rm.c;
	gcc -o bin/heartyfs_read src/heartyfs_ops.c src/op/heartyfs_read.c;
	gcc -o bin/heartyfs_write src/heartyfs_ops.c src/op/heartyfs_write.c;